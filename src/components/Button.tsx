  ...
  `,
  {
    variants: {
      variant: {
        ...
        outline: 'border-2 border-sky-500 text-sky-900 dark:text-sky-100 dark:text-sky-100 bg-white dark:bg-slate-900 dark:bg-slate-900 hover:bg-sky-50 dark:bg-slate-800 dark:bg-slate-800 hover:border-sky-600 dark:border-sky-400 dark:text-sky-100 dark:bg-slate-900 dark:hover:bg-slate-800 dark:hover:border-sky-300',
        ghost: 'text-sky-600 hover:text-sky-700 hover:bg-sky-50 dark:bg-slate-800 dark:bg-slate-800 dark:text-sky-400 dark:hover:text-sky-300 dark:hover:bg-slate-800',
      },
      size: {
        sm: 'h-8 px-3 text-xs',
