...
export default function TikTokUGCWidget({ tripId }: { tripId: string }) {
  ...
  return (
    <div className="bg-white border border-gray-200 rounded-2xl p-8 shadow-sm">
      {/* Header */}
      <div className="mb-8">
        <h2 className="text-3xl font-bold text-gray-900 mb-2">What Adventurers Say</h2>
        <p className="text-gray-600">Real experiences from real travelers on TikTok</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
        {videos.map((video) => (
          <div key={video.id} className="flex flex-col items-center">
            ...
            {/* Creator Info Card */}
            <div className="mt-4 w-full bg-gradient-to-br from-gray-50 to-white rounded-lg p-4 border border-gray-200">
              <a
              ...
              {video.creator_followers > 0 && (
                <p className="text-gray-600 text-xs ml-13">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-pink-50 rounded-xl p-8 text-center border border-blue-200">
        <p className="text-gray-900 font-semibold mb-4">Want to be featured?</p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          ...
          <a
            ...
            className="inline-flex items-center justify-center gap-2 bg-white border border-gray-300 text-gray-900 px-6 py-3 rounded-lg font-semibold hover:bg-gray-50 transition"
          >
            <span>💌</span>
            Creator Inquiry
          </a>
