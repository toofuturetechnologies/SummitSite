  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      <div className="max-w-2xl mx-auto p-8">
        ...
        <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">{tripTitle}</h1>
        <p className="text-gray-600 dark:text-gray-400 mb-8">Add dates when this trip is available</p>
        ...
        <div className="bg-gray-100 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-6 mb-8">
          <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">Add Availability Date</h2>
        ...
        <div className="bg-gray-100 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-lg p-6">
          ...
          {dates.length === 0 ? (
            <p className="text-gray-600 dark:text-gray-400">No dates added yet. Add one above to get started!</p>
          ) : (
            <div className="space-y-3">
              {dates.map(date => (
                <div
                  key={date.id}
                  className="flex items-center justify-between p-4 bg-gray-50 dark:bg-slate-900 rounded-lg border border-gray-200 dark:border-slate-700/50"
                >
