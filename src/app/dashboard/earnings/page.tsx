      ...
      <div className="max-w-6xl mx-auto p-8">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-summit-300">Track your payouts and booking history</p>
          </div>
          <Link
            href="/dashboard"
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-summit-800/50 border border-summit-700 rounded-lg p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-summit-400 text-sm mb-1">Total Earnings</p>
          ...
          <div className="bg-summit-800/50 border border-summit-700 rounded-lg p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-summit-400 text-sm mb-1">Paid Bookings</p>
          ...
          <div className="bg-summit-800/50 border border-summit-700 rounded-lg p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-summit-400 text-sm mb-1">Avg Per Booking</p>
          ...
          <div className="bg-summit-800/50 border border-summit-700 rounded-lg p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-summit-400 text-sm mb-1">Pending Payouts</p>
                <p className="text-3xl font-bold text-summit-300">2-3 days</p>
              </div>
              <TrendingUp className="w-8 h-8 text-summit-600" />
            </div>
          </div>
        ...
        <div className="bg-summit-800/50 border border-summit-700 rounded-lg p-6 mb-8">
          ...
          {paidBookings.length === 0 ? (
            <p className="text-summit-300 text-center py-8">
            ...
            <div className="space-y-2 overflow-x-auto">
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-summit-700">
                    <th className="text-left py-3 px-4 text-summit-400 font-medium">Trip</th>
                    <th className="text-left py-3 px-4 text-summit-400 font-medium">Date</th>
                    <th className="text-right py-3 px-4 text-summit-400 font-medium">Amount</th>
                    <th className="text-right py-3 px-4 text-summit-400 font-medium">
                      Commission (12%)
                    </th>
                    <th className="text-right py-3 px-4 text-summit-400 font-medium">Hosting Fee</th>
                    <th className="text-right py-3 px-4 text-summit-400 font-medium">Your Payout</th>
                    <th className="text-center py-3 px-4 text-summit-400 font-medium">Status</th>
                  </tr>
                </thead>
                <tbody>
                  {paidBookings.map((booking) => (
                    <tr key={booking.id} className="border-b border-summit-700/50 hover:bg-summit-700/20 transition">
                      <td className="py-4 px-4 text-white">{booking.trips.title}</td>
                      <td className="py-4 px-4 text-summit-300">
                        {new Date(booking.created_at).toLocaleDateString()}
                      </td>
                      <td className="py-4 px-4 text-right text-white font-semibold">
                        ${booking.total_price.toFixed(2)}
                      </td>
                      <td className="py-4 px-4 text-right text-summit-400">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-summit-700">
                    <th className="text-left py-3 px-4 text-summit-400 font-medium">Trip</th>
                    <th className="text-left py-3 px-4 text-summit-400 font-medium">Date</th>
                    <th className="text-right py-3 px-4 text-summit-400 font-medium">Original Amount</th>
                    <th className="text-center py-3 px-4 text-summit-400 font-medium">Status</th>
                  </tr>
                </thead>
                <tbody>
