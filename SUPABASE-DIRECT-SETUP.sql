...
-- Add another test guide for variety
INSERT INTO profiles (id, full_name, email, user_type, avatar_url)
VALUES (
...
SELECT COUNT(*) as dates FROM trip_dates;
