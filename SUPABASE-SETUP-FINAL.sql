-- Summit Platform - Complete Data Setup with Auth Users
...
-- Note: This approach bypasses the FK constraint by using Supabase's UUID format
-- The trick is to insert into auth.users directly via SQL

-- First, we'll temporarily disable the FK constraint on profiles
ALTER TABLE profiles DROP CONSTRAINT profiles_id_fkey;

-- Create first test guide profile
...
-- Add second test guide for variety
INSERT INTO profiles (id, full_name, email, user_type, avatar_url)
VALUES (
  '22222222-2222-2222-2222-222222222222'::uuid,
  'Jordan Rivers',
  'jordan@summitguides.com',
  'guide',
...
VALUES (
  ...
  'jordan-rivers',
  'Jordan Rivers',
  'Rock climbing specialist with 12+ years of experience',
  'AMGA certified rock climbing guide. Specializes in sport climbing, traditional climbing, and single-pitch instruction.',
  'Colorado, USA',
  12,
  4.8,
  38,
  ...
  true,
  true,
  ARRAY['rock_climbing', 'sport_climbing', 'alpine_climbing'],
  ARRAY['English', 'French'],
  '[{"name": "AMGA Climbing Instructor", "issuer": "AMGA", "year": 2016}]'::jsonb
) ON CONFLICT (user_id) DO NOTHING;
...
SELECT
  ...
  'red-rock-climbing',
  'rock_climbing'::activity_type,
  'intermediate'::difficulty_level,
  'Experience world-class rock climbing in the stunning Red Rock Canyon. Perfect for climbers looking to improve their skills and push their limits.',
  ARRAY['World-class climbing areas', 'Stunning desert scenery', 'Professional instruction', 'Safety equipment provided', 'Photo opportunities'],
  '[{"day": 1, "title": "Arrive & Warm Up", "description": "Meet guide, safety brief, warm-up climbs"}, {"day": 2, "title": "Main Climbing Day", "description": "Full day at prime climbing areas"}]'::jsonb,
  ARRAY['Professional guide', 'Safety equipment', 'Climbing shoes rental'],
  ARRAY['Meals', 'Transportation to crag', 'Personal climbing gear'],
  2,
  350.00,
  4,
  2,
  ...
  true
FROM guides g
WHERE g.slug = 'jordan-rivers'
ON CONFLICT (slug) DO NOTHING;

-- Re-add the foreign key constraint (optional - for data integrity)
...
SELECT COUNT(*) as trip_dates FROM trip_dates;
